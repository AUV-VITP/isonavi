...
def cmd(name, value, fmt="{}"):
    ...
    if value is None:
        ...
        lines.append(f"\\newcommand{{\\{name}}}{{{indian_group(value)}}}")
    else:
...
_BM = (("bomTotal", "total_inr", "indian"),
       ("bomLakh", "total_lakh_inr", "{:.1f}"),
       ("bomAcoustics", "acoustics_inr", "indian"),
       ("bomAcousticsPct", "acoustics_pct", "{:.0f}"),
       ("bomRest", "non_acoustics_inr", "indian"),
       ("bomRate", "usd_inr", "{:.2f}"))
_BUDGET = (("budgetAirframe", "total_inr", "indian"),
           ("budgetCapital", "capital_inr", "indian"),
           ("budgetMaterials", "materials_inr", "indian"),
           ("budgetValidation", "validation_inr", "indian"),
           ("budgetContingency", "contingency_inr", "indian"),
