...
\pagestyle{fancy}
\fancyhf{}
\lhead{\small\color{accent}isonavi \textbar{} two page brief}
...
\begin{center}
{\LARGE\bfseries\color{accent} isonavi}\\[1mm]
{\large Autonomous underwater reconnaissance for post-flood disaster response}\\[1.5mm]
{\small Technical brief \textbar{} \texttt{github.com/AUV-VITP/isonavi}}
\end{center}
...
\begin{center}
\includegraphics[width=0.66\linewidth]{../cad/isonavi_hero_plain.png}
\end{center}
...
pier and orbit it to measure the hole. isonavi gives up depth, endurance and
...
One airframe costs \INR{\bomTotal} in parts, about \INR{\bomLakh{}~lakh}
at \rupeesign\,\bomRate{} per USD. The distribution is the interesting part:
the two acoustic instruments are \SI{\bomAcousticsPct}{\percent} of it, and
the hull, propulsion, power and the entire autonomy stack together come to
\INR{\bomRest}.

The work in this proposal therefore runs on hardware costing a few tens of
thousand rupees, and it is the part that is genuinely ours. Hulls, thrusters and
...
Not more analysis. Water. The programme is \INR{\budgetProgramme}, about
\INR{\budgetProgrammeLakh{}~lakh}, of which the airframe is \INR{\bomTotal}.
The balance is \INR{\budgetCapital} of equipment bought once and used for every
build after it, \INR{\budgetMaterials} of stock and trial consumables,
\INR{\budgetValidation} of trials, and \INR{\budgetManpower} for
\budgetManpowerMonths{} person months of project staff, with
\SI{\budgetContingencyPct}{\percent} contingency on everything except the
salaries. The full sheet in the technical report gives every line, why it
exists and whether its price is a published one, a quotation, a workshop
estimate or a published fellowship rate.
...
more than funding alone would. A partner with a tank, a reservoir and an
instrumented river reach compresses months 7 to 24 the most.
