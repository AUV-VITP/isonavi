...
build after it, \INR{\budgetMaterials} of stock, and \INR{\budgetValidation} of
trials, with \SI{\budgetContingencyPct}{\percent} contingency. The full sheet
in the technical report gives every line, why it exists and whether its price
is a published one, a quotation or a workshop estimate.
