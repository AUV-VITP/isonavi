...
**[Technical report](docs/isonavi_report.pdf)** (30 pages, design and
...
| Programme cost including capital, materials, trials and manpower | ₹86.7 lakh (₹86,73,412 at ₹95.64 per USD) |
...
| Raw materials and consumables | ₹2,87,016 | Per airframe, with stock to remake the hull once, plus the seals, cells and site kit a trial season consumes |
| Validation and field trials | ₹14,91,984 | Tow tank, witnessed pressure test, pool and reservoir hire, river trials, diver ground truth |
| Manpower | ₹11,16,000 | 36 person months at the standard Project Associate-I rate |
| Contingency at 12 % | ₹8,09,723 | Reserve on everything except salaries |
| **Programme total** | **₹86,73,412** | About ₹86.7 lakh |

The report gives all 66 lines with the reason each one exists and the basis
its price rests on, published, quotation, market, workshop, service or norm.
The whole sheet is generated by `cad/bom.py`, so the totals cannot drift from
the parts list. The report also maps the same lines onto the five standard
budget heads, phased by quarter.
...
17 % of the programme, which is the price of replacing the last of the closed
